...
<?php
    ...
    $sql = "SELECT d.youName, d.youImageFile, f.myCommentID, f.regTime, f.commentEventMsg FROM myEventComment f JOIN myMember d ON(f.myMemberID = d.myMemberID) WHERE f.myEventID = {$myEventID}";
    var_dump($sql);
    $result = $connect -> query($sql);
